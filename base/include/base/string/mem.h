...
#define MEMCPY_ATTRS __THROW __nnull(1, 2) __attr_readonly(2, 3) __attr_writeonly(1, 3)

finline u8  *memcpy8(u8 *_rest _d, const u8 *_rest _s, size_t _n) MEMCPY_ATTRS;
finline u16 *memcpy16(u16 *_rest _d, const u16 *_rest _s, size_t _n) MEMCPY_ATTRS;
finline u32 *memcpy32(u32 *_rest _d, const u32 *_rest _s, size_t _n) MEMCPY_ATTRS;
finline u64 *memcpy64(u64 *_rest _d, const u64 *_rest _s, size_t _n) MEMCPY_ATTRS;

finline void *lgmemcpy(void *_rest dst, const void *_rest src, size_t n) MEMCPY_ATTRS;
finline u8   *lgmemcpy8(u8 *_rest dst, const u8 *_rest src, size_t n) MEMCPY_ATTRS;
finline u16  *lgmemcpy16(u16 *_rest dst, const u16 *_rest src, size_t n) MEMCPY_ATTRS;
finline u32  *lgmemcpy32(u32 *_rest dst, const u32 *_rest src, size_t n) MEMCPY_ATTRS;
finline u64  *lgmemcpy64(u64 *_rest dst, const u64 *_rest src, size_t n) MEMCPY_ATTRS;

#undef MEMCPY_ATTRS
#define MEMSET_ATTRS __THROW __nnull(1) __attr_writeonly(1, 3)

finline u8  *memset8(u8 *_s, u8 _c, size_t _n) MEMSET_ATTRS;
finline u16 *memset16(u16 *_s, u16 _c, size_t _n) MEMSET_ATTRS;
finline u32 *memset32(u32 *_s, u32 _c, size_t _n) MEMSET_ATTRS;
finline u64 *memset64(u64 *_s, u64 _c, size_t _n) MEMSET_ATTRS;

finline void *lgmemset(void *_s, byte _c, size_t _n) MEMSET_ATTRS;
finline u8   *lgmemset8(u8 *s, u8 c, size_t n) MEMSET_ATTRS;
finline u16  *lgmemset16(u16 *s, u16 c, size_t n) MEMSET_ATTRS;
finline u32  *lgmemset32(u32 *s, u32 c, size_t n) MEMSET_ATTRS;
finline u64  *lgmemset64(u64 *s, u64 c, size_t n) MEMSET_ATTRS;

#undef MEMSET_ATTRS

dlimport void *memdup(const void *s, size_t n) __nnull(1) __attr_readonly(1, 2) __attr_malloc;
...
#endif
  vectorize for (size_t i = 0; i < _n; i++) {
    _d[i] = _s[i];
  }
  return _d;
}
