...
#if NO_STD // && LIBC_BASE_IMPLEMENTATION
#  define IAPI finline
...
OAPI char *strdup(cstr s) __THROW ownership_returns(malloc);
OAPI char *strndup(cstr s, size_t n) __THROW ownership_returns(malloc);
#ifdef __cplusplus
extern "C++" {
IAPI cstr  strchr(cstr _s, int _c) __THROW __nnull(1);
IAPI char *strchr(char *_s, int _c) __THROW __nnull(1);
IAPI cstr  strrchr(cstr _s, int _c) __THROW __nnull(1);
IAPI char *strrchr(char *_s, int _c) __THROW __nnull(1);
IAPI cstr  strchrnul(cstr _s, int _c) __THROW __nnull(1);
IAPI char *strchrnul(char *_s, int _c) __THROW __nnull(1);
IAPI cstr  strpbrk(cstr _s, cstr accept) __THROW __nnull(1);
IAPI char *strpbrk(char *_s, cstr accept) __THROW __nnull(1);
IAPI cstr  strstr(cstr _s, cstr _t) __THROW __nnull(1);
IAPI char *strstr(char *_s, cstr _t) __THROW __nnull(1);
IAPI cstr  strcasestr(cstr _s, cstr _t) __THROW __nnull(1);
IAPI char *strcasestr(char *_s, cstr _t) __THROW __nnull(1);
IAPI cstr  basename(cstr __filename) __THROW __nnull(1);
IAPI char *basename(char *__filename) __THROW __nnull(1);
}
#else
IAPI char *strchr(cstr _s, int _c) __THROW __nnull(1);
IAPI char *strrchr(cstr _s, int _c) __THROW __nnull(1);
IAPI char *strchrnul(cstr _s, int _c) __THROW __nnull(1);
IAPI char *strpbrk(cstr _s, cstr accept) __THROW __nnull(1, 2);
IAPI char *strstr(cstr _s, cstr _t) __THROW __nnull(1, 2);
IAPI char *strcasestr(cstr _s, cstr _t) __THROW __nnull(1, 2);
IAPI char *basename(cstr __filename) __THROW __nnull(1);
#endif
IAPI size_t strcspn(cstr s, cstr reject) __THROW __nnull(1, 2);
IAPI size_t strspn(cstr s, cstr accept) __THROW __nnull(1, 2);
IAPI char  *strtok(char *_rest _s, cstr _rest delim) __THROW __nnull(2);
IAPI char  *strtok_r(char *_rest _s, cstr _rest delim, char **_rest save_ptr) __THROW __nnull(2, 3);
