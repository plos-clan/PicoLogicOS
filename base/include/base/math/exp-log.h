...
#  else
dlimport CONST f32 exp2f(f32 x);
dlimport CONST f64 exp2(f64 x);
#  endif
...
#  else
dlimport CONST f32 log2f(f32 x);
dlimport CONST f64 log2(f64 x);
#  endif
...
#  else
dlimport CONST f32 expf(f32 x);
dlimport CONST f64 exp(f64 x);
#  endif
...
#  else
dlimport CONST float  logf(float x);
dlimport CONST double log(double x);
#  endif
...
#  else
dlimport CONST f32 powf(f32 a, f32 b);
dlimport CONST f64 pow(f64 a, f64 b);
#  endif
