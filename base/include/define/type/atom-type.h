...
typedef atomic_uint8_t  au8;
typedef atomic_int16_t  ai16;
typedef atomic_uint16_t au16;
typedef atomic_int32_t  ai32;
typedef atomic_uint32_t au32;
typedef atomic_int64_t  ai64;
typedef atomic_uint64_t au64;
#    ifdef __x86_64__
typedef atomic_int128_t  ai128;
typedef atomic_uint128_t au128;
#    endif
