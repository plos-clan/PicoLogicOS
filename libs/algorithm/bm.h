...
#if !PLOS_LIBALGORITHM_SHOW_WARNING
#  pragma GCC system_header
#endif

static isize bm_nsearch(cstr text, i32 textlen, cstr pattern, i32 patternlen) {
  i32 bc[256];
  for (i32 i = 0; i < 256; i++) {
    bc[i] = patternlen;
  }
...
static isize bm_search(cstr text, cstr pattern) {
...
static isize bm_run(cstr text, i32 textlen, const void *data) {
